...
include $(CLEAR_VARS)
LOCAL_SRC_FILES:= rmalloc/rmalloc.c
LOCAL_MODULE := rmalloc
...
LOCAL_SHARED_LIBRARIES := rmalloc
include $(BUILD_STATIC_LIBRARY)
...
LOCAL_LDLIBS := -llog
LOCAL_CFLAGS := -Wall -O0 -g
LOCAL_SHARED_LIBRARIES := libvisual rmalloc
...
LOCAL_LDLIBS := -llog
LOCAL_CFLAGS := -Wall -O0 -g
LOCAL_SHARED_LIBRARIES := libtinyalsa libvisual rmalloc
include $(BUILD_SHARED_LIBRARY)
...
LOCAL_CFLAGS    := -Wall -O0 -g
LOCAL_STATIC_LIBRARIES := tinyalsa libvisual rmalloc
include $(BUILD_SHARED_LIBRARY)
