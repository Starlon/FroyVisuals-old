...
LOCAL_CFLAGS					:=	-DGL_GLEXT_PROTOTYPES -DPROJECTM_INSIDE -DLINUX -DUSE_GLES1 -DCMAKE_INSTALL_PREFIX="\"/usr\"" -DUSE_THREADS -DSYNC_PRESET_SWITCHES -fexceptions -frtti -DUSE_FBO -DANDROID_FBO_HACK -DUSE_FILE32API #-mfpu=neon -pg
