 ...
 *
 * $Id: actor_lcd.c,v 1.28 2006/01/27 20:19:16 synap Exp $
 *
...
static int lcd_init (VisPluginData *plugin);
static int lcd_cleanup (VisPluginData *plugin);
static int lcd_requisition (VisPluginData *plugin, int *width, int *height);
static int lcd_events (VisPluginData *plugin, VisEventQueue *events);
static VisPalette *lcd_palette (VisPluginData *plugin);
static int lcd_render (VisPluginData *plugin, VisVideo *video, VisAudio *audio);
